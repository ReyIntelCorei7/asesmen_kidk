        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text("No Rekam Medis: ${widget.pemeriksaan!.noRekamMedis}", style: const TextStyle(fontSize: 18.0)),
              const SizedBox(height: 10),
              Text("ID Dokter: ${widget.pemeriksaan!.idDokter}", style: const TextStyle(fontSize: 18.0)),
              const SizedBox(height: 10),
