      ...
      body: Center(
        child: Column(
          children: [
            ...
            const SizedBox(height: 10),
            Text("Pasien: ${widget.resep!.namaPasien ?? widget.resep!.noRekamMedis}", style: const TextStyle(fontSize: 18.0)),
            const SizedBox(height: 10),
            Text("Dokter: ${widget.resep!.namaDokter ?? widget.resep!.idDokter}", style: const TextStyle(fontSize: 18.0)),
            const SizedBox(height: 10),
